...
export default function MobileNav() {
  ...
  return (
    ...
    >
      ...
      <Button onClick={toggleChat} className="flex flex-col gap-0.5 items-center justify-center flex-1 h-full bg-transparent border-transparent hover:text-foreground text-foreground/80 transition-all">
