...
export default function TransactionsFilter() {
  const t = useTranslations('transactions_page.filters');
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="grid md:grid-cols-2 gap-1.5">
        <PageSearch queryKey="txID" placeholder={t('search_placeholder')} />
        <div className="grid grid-cols-2 gap-1.5">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="withdrawal">{t('withdraw')}</SelectItem>
