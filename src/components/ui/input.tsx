  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        className={cn(
          type === "search" ? "!pl-10" : "",
          "selection:bg-primary selection:text-primary-foreground dark:bg-input/30 border-foreground/5  flex h-[41px] w-full min-w-0 rounded-xl border bg-black/10 px-3 py-1 text-[13px] font-medium  shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
